...
public class DistributionLock {
     ...
     */
    public DistributionLock(Jedis jedis, String lockKey) {
     ...
     */
    public DistributionLock(Jedis jedis, String lockKey, int acquireTimeoutMillis) {
     ...
     */
    public DistributionLock(Jedis jedis, String lockKey, int acquireTimeoutMillis, int expiryTimeMillis) {
     ...
     */
    public DistributionLock(Jedis jedis, String lockKey, int acquireTimeoutMillis, int expiryTimeMillis, UUID uuid) {
        this.jedis = jedis;
